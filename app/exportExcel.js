...
var exportExcel = async function (luckysheet, filePath) {
    ...
    luckysheet.every(function (table) {
        ...
        setStyleAndValue(table.data, worksheet, table.config.columnlen);
...
var setStyleAndValue = function (cellArr, worksheet, cols) {
    ...
    cellArr.forEach(function (row, rowid) {
        ...
        row.every(function (cell, columnid) {
            ...
            if (rowid == 0) {
                ...
                if (cols) dobCol.width = cols[columnid] / 8;
                else dobCol.width = 72;
            }
